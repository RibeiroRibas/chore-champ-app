...
class ForgotPasswordCodeStepComponent extends StatefulWidget {
  ...
  @override
  State<ForgotPasswordCodeStepComponent> createState() => _ForgotPasswordCodeStepComponentState();
}

class _ForgotPasswordCodeStepComponentState extends State<ForgotPasswordCodeStepComponent> {
        ...
        children: [
              ...
              return Padding(
                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    onChanged: (v) {
                      if (v.isNotEmpty && i < 3) widget.codeFocusNodes[i + 1].requestFocus();
                    },
                  ),
                ),
              );
          ...
          TextFormField(
            ...
            validator: (v) {
              ...
              if (v != widget.passwordController.text) return 'As senhas não coincidem';
              return null;
            },
          ),
          const SizedBox(height: 24),
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: widget.loading ? null : () {
                if (widget.formKey.currentState?.validate() == true) widget.onResetPassword();
              },
          ...
          const SizedBox(height: 16),
          TextButton(
            onPressed: (widget.resendLoading || widget.loading) ? null : widget.onResend,
